...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name vertical-workload-autoscaler-builder
	$(CONTAINER_TOOL) buildx use vertical-workload-autoscaler-builder
	- $(CONTAINER_TOOL) buildx build --push --platform=$(PLATFORMS) --tag ${IMG} -f Dockerfile.cross .
	- $(CONTAINER_TOOL) buildx rm vertical-workload-autoscaler-builder
	rm Dockerfile.cross
