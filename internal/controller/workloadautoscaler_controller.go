...
// +kubebuilder:rbac:groups=autoscaling.k8s.io.autoscaling.k8s.io,resources=workloadautoscalers,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=autoscaling.k8s.io.autoscaling.k8s.io,resources=workloadautoscalers/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=autoscaling.k8s.io.autoscaling.k8s.io,resources=workloadautoscalers/finalizers,verbs=update
